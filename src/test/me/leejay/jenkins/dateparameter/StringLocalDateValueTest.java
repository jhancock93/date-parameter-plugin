...
public class StringLocalDateValueTest {
    ...
    @Test
    public void string_is_java_format_atStartOfDay() {
        StringLocalDateValue value = new StringLocalDateValue("LocalDateTime.now().atStartOfDay().plusHours(20);", "MM-dd-yyyy HH:mm:ss");
        Assert.assertTrue(value.isJavaFormat());
    }

    @Test
    public void string_parse_java() {
        StringLocalDateValue value = new StringLocalDateValue("LocalDate.now()", "yyyyMMdd");
        Assert.assertEquals(DateTimeFormatter.BASIC_ISO_DATE.format(LocalDate.now()), value.getValue());
    }
    ...
    public void string_parse_java_single_plus_method() {
        ...
        Assert.assertEquals(DateTimeFormatter.BASIC_ISO_DATE.format(LocalDate.now().plusMonths(1)), value.getValue());
    }

    @Test
    public void string_parse_java_atStartOfDay_single_plus_method() {
        StringLocalDateValue value = new StringLocalDateValue("LocalDate.now().atStartOfDay().plusHours(20)", "yyyy-MM-dd HH:mm:ss");
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDate.now().atStartOfDay().plusHours(20)), value.getValue());
    }
    ...
    public void string_parse_java_single_minus_method() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyyMMdd").format(LocalDate.now().minusYears(1)), value.getValue());
    }
    ...
    public void string_parse_java_multiple_plus_methods() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyyMMdd").format(LocalDate.now().plusDays(10).plusYears(1)), value.getValue());
    }
    ...
    public void string_parse_java_multiple_minus_methods() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyyMMdd").format(LocalDate.now().minusDays(10).minusYears(1)), value.getValue());
    }
    ...
    public void string_parse_java_time() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now()), value.getValue());
    }
    ...
    public void string_parse_java_time_single_plus_method() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().plusMonths(1)), value.getValue());
    }
    ...
    public void string_parse_java_time_single_minus_method() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().minusYears(1)), value.getValue());
    }
    ...
    public void string_parse_java_time_multiple_plus_methods() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().plusDays(10).plusYears(1)), value.getValue());
    }
    ...
    public void string_parse_java_time_multiple_minus_methods() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().minusDays(10).minusYears(1)), value.getValue());
    }
    ...
    public void string_parse_java_time_plus_hours() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().plusHours(5)), value.getValue());
    }
    ...
    public void string_parse_java_time_minus_hours() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().minusHours(3)), value.getValue());
    }
    ...
    public void string_parse_java_time_plus_minutes() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().plusMinutes(25)), value.getValue());
    }
    ...
    public void string_parse_java_time_minus_minutes() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().minusMinutes(3)), value.getValue());
    }
    ...
    public void string_parse_java_time_plus_seconds() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().plusSeconds(10)), value.getValue());
    }
    ...
    public void string_parse_java_time_minus_seconds() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().minusSeconds(30)), value.getValue());
    }
    ...
    public void string_parse_java_time_multi_field() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().plusHours(30).plusYears(1).minusSeconds(50)), value.getValue());
    }
    ...
    public void string_parse_java_time_multi_field2() {
        ...
        Assert.assertEquals(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now().minusMinutes(22).plusMonths(3).plusHours(9)), value.getValue());
    }
